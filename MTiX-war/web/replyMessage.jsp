...
<html lang="en">
    ...
    <body>
        ...
        <c:url var="formAction" value="/Controller?action=replyResult" />
                                    ...
                                    <div class="content">             
                                        <form id="contact_form" action="${formAction}" method="POST">
                                            <div class="row">
                                                ...
                                                <p><%=  request.getAttribute("receiver")%> </p>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <textarea id="reply" class="input" name="reply" rows="7" cols="30"></textarea><br />
                                            </div>
