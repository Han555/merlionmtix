<%-- 
    Document   : editingAlert
    Created on : Sep 23, 2016, 11:48:48 PM
    Author     : Student-ID
--%>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">
                            <div class="title">Edit Alert</div>
                        </div>
                    </div>
                    <div class="card-body">
                        <c:url var="formAction" value="/BackController?action=editedAlert" />
                        <form class="form-horizontal" id="formSubmit" action="${formAction}" method="post">
                            ...
                            <div class="form-group" style="padding-bottom: 20px;">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <button type="submit" class="btn btn-default" value="formSubmit">Edit</button>
                                </div>
                            </div>
                        </form>
                    </div>
