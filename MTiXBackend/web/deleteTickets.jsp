    ...
    <div class="side-body padding-top">
        ...
        <div class="row">
            <c:if test="${deleted == 'true'}">
                <font color="red">Tickets successfully deleted!</font><br/>
            </c:if>
        </div>
        <div class="row">
            <c:if test="${exceeded == 'true'}">
                <font color="red">There is no reservation to be deleted!</font><br/>
            </c:if>
        </div>
        <div class="row">
            <div class="col-md-8">
                            ...
                            <tbody>
                                ...
                                <td class="view-message">
                                    <form id="verifyForm" name="verifyForm" action="${formAction}" method="post">
                                        ...
                                        <input type="submit" value="Delete all reservations" /> 
                                    </form></td>
                            ...
                            <tr>
                                <c:forEach begin="1" end="${noOfPages}" var="i">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <td>
                                                <c:url var="linkHref" value="/BackController?action=deleteTickets&page=${i}" />
